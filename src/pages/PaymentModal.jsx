...
export default function PaymentModal({ invoice, payment: editPayment, onClose }) {
  ...
  return (
    ...
    >
      ...
      {isEdit && (
        <div className="flex items-center gap-2 text-xs text-blue-600 bg-blue-50 border border-blue-100 rounded-lg px-3 py-2 mb-4">
      ...
      {displayInvoice ? (
        <div className="flex items-center justify-between bg-blue-50 rounded-xl px-4 py-3 mb-4">
          ...
          <span className="font-bold text-blue-600 text-lg">{fmt(displayInvoice.amount)}</span>
        </div>
      ) : (
