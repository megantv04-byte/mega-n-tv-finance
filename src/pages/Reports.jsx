...
const PARTNERS   = ['Bledi', 'Belti']
const P_COLOR    = { Bledi: '#7c3aed', Belti: '#059669' }
...
function BarazimiTab({ payments, expenses, fmt }) {
  ...
  const [trfFrom, setTrfFrom] = useState('Bledi')
  ...
  const settlement = (() => {
    ...
    return diff > 0
      ? { from:'Bledi', to:'Belti', amount: diff }
      : { from:'Belti', to:'Bledi', amount: -diff }
  })()
