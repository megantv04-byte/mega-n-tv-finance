...
export const mockItems = [
  { id: 'ITM-001', name: '1 muaj abonim',                                  salePrice: 10,  purchasePrice: 0, account: '7010', vendor: 'Predator' },
  { id: 'ITM-002', name: '3 muaj abonim',                                  salePrice: 40,  purchasePrice: 0, account: '7010', vendor: 'Predator' },
  { id: 'ITM-003', name: '2 muaj abonim',                                  salePrice: 20,  purchasePrice: 0, account: '7010', vendor: 'Predator' },
  { id: 'ITM-004', name: '6 muaj abonim',                                  salePrice: 60,  purchasePrice: 0, account: '7010', vendor: 'Predator' },
  { id: 'ITM-005', name: '12 muaj abonim',                                 salePrice: 100, purchasePrice: 0, account: '7010', vendor: 'Predator' },
  { id: 'ITM-006', name: '13 muaj abonim',                                 salePrice: 110, purchasePrice: 0, account: '7010', vendor: 'Predator' },
  { id: 'ITM-007', name: 'Ibo Player - Pagese e aplikacionit',             salePrice: 10,  purchasePrice: 0, account: '7030', vendor: 'Ibosol' },
  { id: 'ITM-008', name: 'Netiptv - Pagese e aplikacionit per 2 vite',     salePrice: 10,  purchasePrice: 0, account: '7030', vendor: 'Netiptv' },
  { id: 'ITM-009', name: 'Smart IPTV - Pagese e aplikacionit',             salePrice: 10,  purchasePrice: 0, account: '7030', vendor: 'Smart IPTV' },
  { id: 'ITM-010', name: 'Set IPTV - Pagese e aplikacionit',               salePrice: 20,  purchasePrice: 0, account: '7030', vendor: 'Set IPTV' },
  { id: 'ITM-011', name: 'PREDATOR APK - Pagese e aplikacionit',           salePrice: 10,  purchasePrice: 0, account: '7030', vendor: 'X' },
  { id: 'ITM-012', name: 'STB - Pagese e aplikacionit',                    salePrice: 20,  purchasePrice: 0, account: '7030', vendor: 'STB' },
  { id: 'ITM-013', name: 'Hot IPTV - Pagese e aplikacionit',               salePrice: 15,  purchasePrice: 0, account: '7030', vendor: 'Hot IPTV' },
  { id: 'ITM-014', name: 'Kredit - Predator',                              salePrice: 2.50, purchasePrice: 0, account: '7090', vendor: 'Predator' },
  { id: 'ITM-015', name: 'Kredit - Ibo Player',                            salePrice: 2,   purchasePrice: 0, account: '7090', vendor: 'Ibosol' },
  { id: 'ITM-016', name: 'Netiptv - Pagese e aplikacionit lifetime',       salePrice: 20,  purchasePrice: 0, account: '7030', vendor: 'Netiptv' },
  ...
  { id: 'ITM-020', name: '3 Muaj Test',                                    salePrice: 15,  purchasePrice: 0, account: '7010', vendor: 'Predator' },
  ...
  { id: 'ITM-023', name: 'Spotify - 12 Muaj',                              salePrice: 50,  purchasePrice: 0, account: '7030', vendor: 'Tikeys' },
  { id: 'ITM-024', name: 'Bob Player - Pagese e aplikacionit',             salePrice: 10,  purchasePrice: 0, account: '7030', vendor: 'Ibosol' },
  { id: 'ITM-025', name: 'Oferta Black Friday x2',                         salePrice: 100, purchasePrice: 0, account: '7010', vendor: 'Predator' },
  { id: 'ITM-026', name: '12 Muaj Abonim X2',                              salePrice: 200, purchasePrice: 0, account: '7010', vendor: 'Predator' },
  { id: 'ITM-027', name: '8K - 12 muaj abonim',                            salePrice: 160, purchasePrice: 0, account: '7010', vendor: 'Strong - 8K' },
  { id: 'ITM-028', name: 'Trex - 6 muaj abonim',                           salePrice: 60,  purchasePrice: 0, account: '7010', vendor: 'Trex' },
  { id: 'ITM-029', name: 'Smart One Lifetime',                             salePrice: 20,  purchasePrice: 0, account: '7030', vendor: 'Smart ONE' },
  { id: 'ITM-030', name: 'Proxy',                                          salePrice: 10,  purchasePrice: 0, account: '7010', vendor: 'Proxypass' },
  { id: 'ITM-031', name: '12+2 muaj abonim',                               salePrice: 100, purchasePrice: 0, account: '7010', vendor: 'Predator' },
  { id: 'ITM-032', name: 'Roku TV Express 4K',                             salePrice: 60,  purchasePrice: 0, account: '7000', vendor: 'Amazon' },
  { id: 'ITM-033', name: 'TIP',                                            salePrice: 10,  purchasePrice: 0, account: '7090', vendor: 'X' },
  { id: 'ITM-034', name: 'Smarters IPTV Player',                           salePrice: 10,  purchasePrice: 0, account: '7030', vendor: 'Smarters IPTV' },
  { id: 'ITM-035', name: 'VIP - Trex',                                     salePrice: 50,  purchasePrice: 0, account: '7010', vendor: 'Trex' },
  { id: 'ITM-036', name: 'Netiptv - Pagese e aplikacionit per 1 vit',      salePrice: 5,   purchasePrice: 0, account: '7030', vendor: 'Netiptv' },
  { id: 'ITM-037', name: '8K - 6 Muaj',                                    salePrice: 80,  purchasePrice: 0, account: '7010', vendor: 'Strong - 8K' },
  { id: 'ITM-038', name: '8K - 3 Muaj abonim',                             salePrice: 40,  purchasePrice: 0, account: '7010', vendor: 'Strong - 8K' },
]
