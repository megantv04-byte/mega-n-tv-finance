...
export class MultiTenantDebug {
  ...
  static validateSession() {
    const session = localStorage.getItem('meganntv_session')
    const user = localStorage.getItem('meganntv_user')
  ...
  static validateDataStructure() {
    ...
    const invoicesStr = localStorage.getItem('meganntv_invoices')
    if (invoicesStr) {
      try {
    ...
    // Check customers
    const customersStr = localStorage.getItem('meganntv_customers')
    if (customersStr) {
      try {
